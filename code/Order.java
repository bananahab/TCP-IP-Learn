...
public class Order extends JFrame2 implements ActionListener{   //打开订单信息管理界面
    ...
    public void display() {  //显示所有订单信息
        ...
        String[] columnName={"客户名称","地址","电话","产品","数量"};
        try {
    ...
    public void find(String name3) {   //查询订单信息

        Object[][] playerInfo = new Object[1][5];
        String[] columnNames = {"客户名称", "地址", "电话", "产品", "数量"};
        try {
