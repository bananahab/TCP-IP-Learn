...
public class PutIn extends JFrame2 implements ActionListener{  //打开入库管理系统
    ...
    public void display() {
        ...
        String[] columnName={"客户名称","地址","电话","产品","数量","时间"};
        try {
            String demo1 = "select * from putin";
            ...
            while (result1.next()){
                ...
                playerInfo[j][5]=result1.getString("date");
                j++;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void delete(){
        ...
        String name1=null,address1=null,phone1=null,product1=null,quantity1=null,date1=null;
        if(row==-1){
            ...
            int num1 = 0;
            try {
                String demo2 = "delete from putin where name='"+name1+"'";
    ...
    public void find(String name3) {
        ...
        String[] columnNames = {"客户名称", "地址", "电话", "产品", "数量","时间"};
        try {
            String demo = "select * from putin where name='"+name3+"'";
            PreparedStatement ps = connection.prepareStatement(demo);
            ResultSet result = ps.executeQuery();
            while(result.next()) {
                ...
                playerInfo[0][5] =result.getString("date");
            }
    ...
    public void add(){
        ...
        panel2.add(addQuantity);panel2.add(date);panel2.add(addDate);panel2.add(submit);
        frame.add(panel2);
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    String demo = "insert into putin values(?,?,?,?,?,?)";
                    PreparedStatement ps = connection.prepareStatement(demo);
                    ...
                    ps.setString(6,addDate.getText());
